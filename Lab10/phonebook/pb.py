...
if __name__ == '__main__':  
    drop_tables()
    create_tables()
    insert_contacts([("vasily", "oreshnikov", "79128231568"), ("Bogdan", "Oramjapyraq", "77716642611"),
                    ("Sun", "Huichai", "861319555608")])
    insert_contacts_csv("sample_data.csv")
    filter()
    update("last_name", "Jmishenko", "first_name", "Valery Albertovich")
    filter("id", "LOWER(first_name) LIKE 'va%'")
    delete(("Nikita", "Sivkov"))
    filter()